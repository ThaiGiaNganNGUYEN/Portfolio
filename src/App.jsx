  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 md:px-12 py-24 bg-black text-white">
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        >
          WHERE CURIOSITY MEETS PROBLEM SOLVING.<br><br></>THIS IS A SPACE WHERE I EXPLORE CYBERSECURITY, CODE, AND CREATIVITY TO BUILD SOLUTIONS THAT EMPOWER PEOPLE AND MAKE TECHNOLOGY FEEL A LITTLE MORE HUMAN.
        </p>
